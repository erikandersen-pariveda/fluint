package net.digitalprimates.flex2.uint.tests
{
  ...
  import net.digitalprimates.flex2.uint.ui.TestComponentViewer;
  import net.digitalprimates.flex2.uint.utils.ArrayUtils;
  import net.digitalprimates.flex2.uint.utils.ComponentFinder;
  ...
  public class ComponentTestCase extends TestCase
  {
    ...
    public function typeInto( value:String, target:Object ) : void 
    {
      ...
      sequence.addStep( new SequenceAction(function():void {
    ...
    public function select( value:Object, target:Object, propertiesToMatchOn : Array = null ) : void 
    {
      ...
      sequence.addStep(new SequenceAction(function() {
          var uiComponent : UIComponent = processComponentReference(target);
...
//           uiComponent.dispatchEvent(new ItemClickEvent(ItemClickEvent.ITEM_CLICK, true, false, null, value as int));
    ...
    public function invoke( object:Object, methodName:String, params:Array = null) : void 
    {
      ...
      sequence.addStep(new SequenceAction(object[methodName], object, params));  
    }
